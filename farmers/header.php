...
if(isset($_SESSION['farmer_id'])){
  ...
  if(mysqli_num_rows($user_result) == 1 ){
    $farm_name = $row['full_names'];
    $farm_password = $row['user_password'];
...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <p style = "color: black; font-size:30px">Euro Farm</p>
        ...
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="index.php">
              ...
              <span class="menu-title">View My Products</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../database_operations/logout_farmer.php">
