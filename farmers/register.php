...
<hr class="mb-5"/>
        ...
        <?php
          ...
          <h3 class="secondary-heading">
            Register to sell your farm products with us.
          ...
          <section class="pr-1">
            ...
            <div class="card">
              ...
              <div class="card-body px-lg-5 pt-0">
                ...
                <!-- Form -->
                <form class="text-center" method= "POST" action="../database_operations/register_farmer.php" enctype="multipart/form-data" style="color: #757575;">
    
                  <div class="form-row">
                    <div class="col">
                      <!-- First name -->
                      <div class="md-form">
                        <input type="text" name= "farm_name" required id="materialRegisterFormFirstName" class="form-control">
                        <label for="materialRegisterFormFirstName" class="active">Farm name</label>
                      </div>
                    </div>
                    <div class="col">
                      <!-- Last name -->
                  ...
                  <!-- Social register -->
                  <p>or <a href="user_login.php">Sign in</a> if you already have an account:</p>
