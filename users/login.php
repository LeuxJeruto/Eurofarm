      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="mb-4">
              <h3>Sign In to <strong>EuroFarm</strong></h3>
              <p class="mb-4">Where you can buy goods easily/p>
            </div>
            <?php
          session_start();
        ...
        <?php
            ...
            <form action="../database_operations/login_user.php" method="post">
              <div class="form-group first">
                <label for="Farmname">User Email</label>
                <input type="text" require name = "email"  class="form-control" id="username">
