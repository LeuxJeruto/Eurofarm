                                  ...
                                  if(mysqli_num_rows($result) > 0){
                                      ...
                                      ?> 
                                        <div class="col-md-12 d-flex ftco-animate">
                                            ...
                                            <a href="blog-single.html" class="block-20" style="background-image: url('../blog_upload_images/<?php echo $row['blog_image'] ?>');">
                                            </a>
                                            <div class="text d-block pl-md-4">
                                                ...
                                                <p><a href="single_blog.php?view=<?php echo $row['id'] ?>" class="btn btn-primary py-2 px-3">Read more</a></p>
                                            </div>
                                            </div>
                                        </div>
                                      <?php
